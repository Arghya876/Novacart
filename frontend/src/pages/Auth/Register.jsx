    ...
    <div className="min-h-[75vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md p-8 border border-neutral-100 dark:border-neutral-850 bg-white dark:bg-neutral-900 rounded-3xl shadow-xl space-y-6 backdrop-blur">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-neutral-455 dark:text-neutral-400">Join NovaCart and experience premium shopping</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-neutral-400 uppercase">I want to register as a:</label>
        ...
        <p className="text-center text-xs text-neutral-455 dark:text-neutral-500">
