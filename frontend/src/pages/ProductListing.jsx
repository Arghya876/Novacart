...
import { Filter, ChevronDown, RefreshCw, Star, X } from 'lucide-react';
...
export default function ProductListing() {
  ...
  const activeFilterCount = [minPrice, maxPrice, rating, selectedCategory].filter(Boolean).length;
    ...
    <form onSubmit={handleFilterApply} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-1">
          <label className="flex items-center gap-2.5 text-xs text-neutral-600 dark:text-neutral-400 cursor-pointer py-1">
            <input
              type="radio"
              name="category"
              value=""
      ...
      <button
        type="submit"
        className="w-full h-10 rounded-xl bg-violet-600 hover:bg-violet-700 text-white text-xs font-semibold transition-all shadow-sm cursor-pointer"
      >
        Apply Filters
      </button>
    </form>
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
          <button
            ...
            className="lg:hidden h-10 px-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-xs font-semibold text-neutral-800 dark:text-neutral-200 flex items-center gap-2"
          >
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs text-neutral-450 dark:text-neutral-500 font-medium hidden sm:inline">Sort By:</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        {isMobileFilterOpen && (
          <div className="fixed inset-0 z-50 lg:hidden flex">
            ...
            />
            <div className="relative ml-auto w-full max-w-xs h-full bg-white dark:bg-neutral-900 p-6 shadow-2xl flex flex-col justify-between overflow-y-auto z-10">
              <div>
                <div className="flex items-center justify-between pb-4 border-b border-neutral-100 dark:border-neutral-850 mb-6">
                  <h3 className="font-bold text-sm text-neutral-900 dark:text-white flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button onClick={() => setIsMobileFilterOpen(false)} className="text-neutral-400 hover:text-neutral-600">
                      <X className="h-5 w-5" />
                    </button>
                  </div>
                </div>
